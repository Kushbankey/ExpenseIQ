      ...
      <Card title="Your data">
        <div className="flex items-center justify-between gap-4 flex-wrap">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-violet-600 text-white text-sm font-medium rounded-xl hover:bg-violet-700 transition-colors flex-shrink-0"
          >
            <Upload size={16} />
            Upload new sheet
          </button>
        ...
        {showSuccess && (
          <div className="mt-4 flex items-center gap-2 px-3 py-2 bg-emerald-50 text-emerald-700 text-sm rounded-lg">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
              <div>
                <h3 className="text-base font-semibold text-gray-900">Replace your data</h3>
