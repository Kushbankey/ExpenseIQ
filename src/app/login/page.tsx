  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0c] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleLogin} className="bg-white dark:bg-[#131316] rounded-2xl shadow-sm dark:shadow-none border border-gray-100 dark:border-gray-800/80 p-6 space-y-4">
          {error && (
          ...
          <p className="text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <Link href="/signup" className="text-violet-600 dark:text-violet-300 font-medium hover:underline">Sign up</Link>
          </p>
        </form>
      </div>
    </div>
